...
function initQuickText(){
    ...
    pNodes.innerHTML='\
        ...
        <p>&nbsp&nbsp&nbsp&nbsp&nbspfind min i fullfill A[i]>A[pivot]</p>\
        <p>&nbsp&nbsp&nbsp&nbsp&nbspfind max j fullfill A[i]&ltA[pivot]</p>\
        <p>&nbsp&nbsp&nbsp&nbsp&nbspswap(i, storeIndex);}<br>&nbsp&nbspstoreIndex++<br>&nbsp&nbsp&nbsp&nbsp}</p>\
